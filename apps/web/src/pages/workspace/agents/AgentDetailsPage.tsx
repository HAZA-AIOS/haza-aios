...
export const AgentDetailsPage: React.FC = () => {
  ...
  if (loading) return <AppShell><div className="p-6 text-muted-foreground">Loading agent details...</div></AppShell>;
  if (!template) return <AppShell><div className="p-6 text-destructive">Agent not found.</div></AppShell>;
