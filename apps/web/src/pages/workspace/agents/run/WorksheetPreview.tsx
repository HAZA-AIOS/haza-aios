...
export const WorksheetPreview: React.FC<WorksheetPreviewProps> = ({ worksheet, onSave, isSaving }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      {worksheet.debugContext && (
        <Card className="bg-purple-950/20 border-purple-900/50">
          <CardHeader className="py-3">
            <CardTitle className="text-xs text-purple-400 uppercase tracking-wider">Agent Knowledge Context (Debug)</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-sm text-purple-200 font-mono">{worksheet.debugContext}</p>
          </CardContent>
        </Card>
      )}
