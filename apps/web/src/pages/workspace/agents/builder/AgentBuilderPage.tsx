...
type Tab = "General" | "Instructions" | "Behavior" | "Inputs" | "Outputs" | "Tools" | "Model & Memory" | "Preview";
...
export const AgentBuilderPage: React.FC = () => {
  ...
  if (!instance || !template || !configDraft) return <div className="p-6">Loading Builder...</div>;
  ...
  const tabs: Tab[] = [
    "General", "Instructions", "Behavior", "Inputs", "Outputs", "Tools", "Model & Memory", "Preview"
  ];
