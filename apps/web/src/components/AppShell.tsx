...
function AppShell({ children }: AppShellProps) {
  ...
  return (
    <div className="flex min-h-screen bg-[#080b11] text-white antialiased font-sans">
      ...
      >
        {/* Brand Logo */}
        <div className="flex items-center justify-center gap-3 w-full px-2 mb-6 relative group">
          <LogoMark className="size-8 text-yellow-500 shrink-0" />
          <div className="absolute left-full ml-4 top-1/2 -translate-y-1/2 px-3 py-1.5 bg-slate-900 border border-white/10 text-white text-xs font-semibold rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all whitespace-nowrap z-50">
            HAZA AIOS
          </div>
        </div>
        ...
        {isAdminMode && (
          <div className="w-full px-2 mb-6 relative group">
            <div className={`flex justify-center py-2 items-center gap-2 rounded-xl bg-red-500/10 border border-red-500/20 transition-all`}>
          ...
          {navItems.map((item) => {
            ...
            return (
              <div key={item.label} className="relative group/nav">
                ...
                >
                  <div className={`shrink-0 transition-transform group-hover/nav:scale-105 ${active ? "text-red-500" : ""}`}>
                    {item.icon}
                  </div>
                </button>
                <div className="absolute left-full ml-4 top-1/2 -translate-y-1/2 px-3 py-1.5 bg-slate-900 border border-white/10 text-white text-xs font-semibold rounded-lg shadow-xl opacity-0 invisible group-hover/nav:opacity-100 group-hover/nav:visible transition-all whitespace-nowrap z-50">
                  {item.label}
                </div>
              </div>
            );
        ...
        <div className="w-full pt-4 border-t border-white/5 space-y-2">
          ...
          {!isAdminMode && isSuperAdmin && (
            <div className="relative group/nav">
              <button
                ...
                className="flex items-center justify-center w-full p-3 rounded-xl transition-all duration-200 text-slate-400 hover:text-red-400 hover:bg-red-500/5 border border-transparent"
              >
                <div className="shrink-0 transition-transform group-hover/nav:scale-105">
                  <svg className="size-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
                  </svg>
                </div>
          ...
          {isAdminMode && (
            <div className="relative group/nav">
              <button
                ...
                className="flex items-center justify-center w-full p-3 rounded-xl transition-all duration-200 text-slate-400 hover:text-white hover:bg-white/5 border border-transparent"
              >
                <div className="shrink-0 transition-transform group-hover/nav:-translate-x-1">
                  <svg className="size-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="relative group/nav">
            ...
            >
              <div className="shrink-0 transition-transform group-hover/nav:rotate-45 duration-300">
                {bottomNavItem.icon}
              </div>
            </button>
            <div className="absolute left-full ml-4 top-1/2 -translate-y-1/2 px-3 py-1.5 bg-slate-900 border border-white/10 text-white text-xs font-semibold rounded-lg shadow-xl opacity-0 invisible group-hover/nav:opacity-100 group-hover/nav:visible transition-all whitespace-nowrap z-50">
